...
public class Admin {
    ...
    public ResponseEntity<?> pdfFetcherFromLocation(@RequestParam(name = "pdfUrl",required = false) String pdfUrl,@RequestParam(name = "pageNo") int pageNo) throws IOException {
        return service.fetchPdf(pdfUrl, pageNo);
    }
