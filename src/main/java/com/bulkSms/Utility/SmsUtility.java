...
//            smsBody = feedbackMessage + submitFeedbackUrl + "/" + smsSendDetails.getFileSequenceNo() + "/" + smsSendDetails.getMobileNumber();    removed phone number from feedback url
            smsBody = feedbackMessage + submitFeedbackUrl + "/" + smsSendDetails.getFileSequenceNo();
